...
const en: SiteContent = {
  ...
  industries: {
    ...
    manufacturing: {
      slug: "manufacturing",
      name: "Manufacturing",
      heroTitle: "Sustainability for manufacturing.",
      heroDesc: "Production-integrated emissions tracking and multi-site compliance, automated end to end.",
      challenges: [
        { title: "Multi-site footprint", desc: "Hundreds of lines across many plants." },
        { title: "Shop-floor data", desc: "Meters rarely connected to corporate ESG." },
        { title: "Supplier risk", desc: "Upstream impact often invisible." },
      ],
      solutions: [
        { title: "Connected meters", desc: "Shop-floor data flows to ESG automatically." },
        { title: "Multi-site rollup", desc: "Portfolio view with site drill-down." },
        { title: "Supplier scoring", desc: "Extend visibility upstream." },
      ],
      modules: ["environmental-monitoring", "carbon-accounting", "waste-management", "ai-insights"],
      caseStudy: {
        quote: "Our last ISO 14001 audit was the cleanest we have had in a decade. The data just lined up.",
        name: "Ahmad Prasetyo",
        role: "HSE Director",
        company: "Indocement",
    ...
    mining: {
      slug: "mining",
      name: "Mining",
      heroTitle: "Sustainability for mining & extraction.",
      heroDesc: "Site-level impact monitoring, biodiversity compliance, and tailings management across remote operations.",
      challenges: [
        { title: "Remote sites", desc: "Distributed, hard-to-reach operations." },
        { title: "Biodiversity", desc: "Strict monitoring and offset obligations." },
        { title: "Tailings", desc: "High-consequence storage and reporting." },
      ],
      solutions: [
        { title: "Site monitoring", desc: "Land, water, and energy in one view." },
        { title: "Biodiversity tracking", desc: "Compliance against local requirements." },
        { title: "Tailings reporting", desc: "Structured, auditable records." },
      ],
      modules: ["environmental-monitoring", "water-monitoring", "compliance-management", "ai-insights"],
      caseStudy: {
        quote: "ensPR gave our remote sites a single dashboard the head office finally trusts.",
        name: "Dewi Anggraini",
        role: "ESG Lead",
        company: "Timah Industri",
        metricLabel: "Sites unified",
        metricValue: "22",
      },
    },
    steel: {
      slug: "steel",
      name: "Steel & Metals",
      heroTitle: "Sustainability for steel & metals.",
      heroDesc: "High-volume emissions management with blast-furnace-level granularity and reduction pathways.",
      challenges: [
        { title: "Volume", desc: "Some of the highest emissions intensity in industry." },
        { title: "Process detail", desc: "Impact tied to specific furnaces and lines." },
        { title: "Decarbonization", desc: "Pressure to set and hit credible targets." },
      ],
      solutions: [
        { title: "Line-level accounting", desc: "Attribute emissions to specific furnaces." },
        { title: "Target tracking", desc: "Monitor decarbonization trajectory." },
        { title: "Scenario models", desc: "Compare electrification and fuel switches." },
      ],
      modules: ["environmental-monitoring", "carbon-accounting", "life-cycle-assessment", "ai-insights"],
      caseStudy: {
        quote: "The LCA module gave us a granular view of our process footprint we simply did not have before.",
        name: "Sandra Wijaya",
        role: "Environmental Engineer",
        company: "Krakatau Steel",
        metricLabel: "Footprint clarity",
        metricValue: "3x",
      },
    },
    utilities: {
...
const id: SiteContent = {
  ...
  footer: {
    ...
    col2: "Industri",
    col2l: ["Kimia", "Manufaktur", "Pertambangan", "Baja & Logam", "Utilitas"],
    col3: "Perusahaan",
  ...
  industries: {
    ...
    manufacturing: {
      slug: "manufacturing",
      name: "Manufaktur",
      heroTitle: "Keberlanjutan untuk manufaktur.",
      heroDesc: "Pelacakan emisi terintegrasi produksi dan kepatuhan multi-situs, otomatis dari ujung ke ujung.",
      challenges: [
        { title: "Jejak multi-situs", desc: "Ratusan lini di banyak pabrik." },
        { title: "Data lantai produksi", desc: "Meter jarang terhubung ke ESG korporat." },
        { title: "Risiko supplier", desc: "Dampak hulu sering tak terlihat." },
      ],
      solutions: [
        { title: "Meter terhubung", desc: "Data lantai produksi mengalir ke ESG otomatis." },
        { title: "Rollup multi-situs", desc: "Tampilan portofolio dengan drill-down situs." },
        { title: "Skor supplier", desc: "Perluas visibilitas ke hulu." },
      ],
      modules: ["environmental-monitoring", "carbon-accounting", "waste-management", "ai-insights"],
      caseStudy: {
        quote: "Audit ISO 14001 terakhir kami adalah yang paling rapi dalam satu dekade. Datanya langsung selaras.",
        name: "Ahmad Prasetyo",
        role: "Direktur HSE",
        company: "Indocement",
        metricLabel: "Skor kepatuhan",
        metricValue: "98%",
      },
    },
    mining: {
      slug: "mining",
      name: "Pertambangan",
      heroTitle: "Keberlanjutan untuk pertambangan & ekstraksi.",
      heroDesc: "Pemantauan dampak level situs, kepatuhan keanekaragaman hayati, dan manajemen tailing di operasi terpencil.",
      challenges: [
        { title: "Situs terpencil", desc: "Operasi terdistribusi dan sulit dijangkau." },
        { title: "Keanekaragaman hayati", desc: "Pemantauan dan kewajiban offset ketat." },
        { title: "Tailing", desc: "Penyimpanan dan pelaporan berkonsekuensi tinggi." },
      ],
      solutions: [
        { title: "Pemantauan situs", desc: "Lahan, air, dan energi dalam satu tampilan." },
        { title: "Pelacakan biodiversity", desc: "Kepatuhan terhadap persyaratan lokal." },
        { title: "Pelaporan tailing", desc: "Catatan terstruktur dan dapat diaudit." },
      ],
      modules: ["environmental-monitoring", "water-monitoring", "compliance-management", "ai-insights"],
      caseStudy: {
        quote: "ensPR memberi situs terpencil kami satu dashboard yang akhirnya dipercaya kantor pusat.",
        name: "Dewi Anggraini",
        role: "Lead ESG",
        company: "Timah Industri",
        metricLabel: "Situs disatukan",
        metricValue: "22",
      },
    },
    steel: {
      slug: "steel",
      name: "Baja & Logam",
      heroTitle: "Keberlanjutan untuk baja & logam.",
      heroDesc: "Manajemen emisi volume tinggi dengan granularitas level tanur tinggi dan jalur reduksi.",
      challenges: [
        { title: "Volume", desc: "Salah satu intensitas emisi tertinggi di industri." },
        { title: "Detail proses", desc: "Dampak terikat pada tanur dan lini tertentu." },
        { title: "Dekarbonisasi", desc: "Tekanan untuk menetapkan dan capai target kredibel." },
      ],
      solutions: [
        { title: "Akuntansi level lini", desc: "Kaitkan emisi ke tanur tertentu." },
        { title: "Pelacakan target", desc: "Awasi trajektori dekarbonisasi." },
        { title: "Model skenario", desc: "Bandingkan elektrifikasi dan penggantian bahan bakar." },
      ],
      modules: ["environmental-monitoring", "carbon-accounting", "life-cycle-assessment", "ai-insights"],
      caseStudy: {
        quote: "Modul LCA memberi kami pandangan granular atas jejak proses yang sebelumnya tidak kami miliki.",
        name: "Sandra Wijaya",
        role: "Engineer Lingkungan",
        company: "Krakatau Steel",
        metricLabel: "Kejelasan jejak",
        metricValue: "3x",
      },
    },
    utilities: {
